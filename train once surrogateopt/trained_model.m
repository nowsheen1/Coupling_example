...
rng("default");
num_points = 30;  % Number of design points for each subsystem
num_vars = 3;     % Number of design variables per subsystem (you can increase this)
...
lb1 = [0,0,0];  % Lower bound for Subsystem 1
ub1 = [10,10,10];  % Upper bound for Subsystem 1
for i=1:num_points
...
for i=1:num_points 
    Sub_system_1_output(i,:)=Sub_system_1_opt(design_points(i,1),design_points(i,2),design_points(i,3));
    Sub_system_2_output(i,:)=Sub_system_2_opt(design_points(i,1),design_points(i,2),design_points(i,3));
end
